...
export interface MiroslavasCreaturesInterface extends utils.Interface {
  ...
  functions: {
    ...
    "mintCreature(uint256)": FunctionFragment;
...
export interface MiroslavasCreatures extends BaseContract {
  contractName: "MiroslavasCreatures";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MiroslavasCreaturesInterface;
